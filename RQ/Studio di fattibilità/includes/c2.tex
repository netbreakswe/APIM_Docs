...
con l'utente, i servizi \textit{AWS Lambda\ped{G}} per l'interazione con l'API dell'assistente
...
\begin{itemize}
	...
	\item \textbf{\textit{Express\ped{G}}}, come eventuale framework Node.js;
