...
Il capitolato proposto da Red Babel tratta la creazione di un framework Monolith, implementato come package di \textit{Rocket.chat\ped{G}}. Lo scopo di questo
...
Questo framework si offre a tutti gli sviluppatori che necessitano di introdurre un sistema più avanzato per lo scambio di dati, come può essere un'azienda che vuole offrire una \textit{customer communication dashboard\ped{G}} ai suoi clienti come strumento di assistenza o un bot che risponda in modo automatico alle domande più frequenti. 

\subsection{Tecnologie}

Per la realizzazione di questo capitolato è necessario l'utilizzo delle seguenti tecnologie:
\begin{itemize}
	\item \textbf{\textit{JavaScript ES6\ped{G}}}, per lo sviluppo della parte back-end;
	\item \textbf{\textit{Angular2\ped{G}}}, per la parte front-end;
	\item \textbf{HTML5}, \textbf{CSS3} e \textbf{\textit{SASS\ped{G}}}, per la struttura e l'aspetto grafico;
\end{itemize}
