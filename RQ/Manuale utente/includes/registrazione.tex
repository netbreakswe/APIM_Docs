...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[scale=0.60]{img/APIM_registrazione.JPG}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[scale=0.60]{img/APIM_login.JPG}}
	\caption{Login}
\end{figure}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[scale=0.60]{img/APIM_recuperoPSW.JPG}}
